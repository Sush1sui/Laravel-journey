    ...
    <nav class="bg-gray-800">
      ...
      <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
          <x-nav-link-mobile type="a" href="/" :active="request()->is('/')">Home</x-nav-link-mobile>
          <x-nav-link-mobile type="a" href="/jobs" :active="request()->is('jobs')">Jobs</x-nav-link-mobile>
          <x-nav-link-mobile type="a" href="/contact" :active="request()->is('contact')">Contact</x-nav-link-mobile>
        </div>
